...
# Prepare data and Laplacian matrix
data = dataset[0]
...
# Compute normalized Laplacian for ChebNetII
#L=I-D^(-0.5)AD^(-0.5)
...
# ChebNetII model with second-order Chebyshev polynomials
class Net(nn.Module):
